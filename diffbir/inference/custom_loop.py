...
from ..model.SCEIR.train import SCEIR_Model
...
class CustomInferenceLoop(InferenceLoop):
    ...
    def load_cleaner(self) -> None:
        ...
        self.cleaner: SCEIR_Model = SCEIR_Model(self.args, mode='test').to(self.args.device)
        self.cleaner.load_checkpoint(self.args.SCEIR_path, self.args.device)
        self.cleaner.eval()
    ...
    def after_load_lq(self, lq: Image.Image) -> np.ndarray:
        ...
        # )
        lq = lq.resize((256, 256), Image.BILINEAR)
