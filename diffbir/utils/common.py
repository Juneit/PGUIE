...
def calculate_ssim(img, img2, crop_border, test_y_channel=False):
    """Calculate SSIM (Structural Similarity Index) (PyTorch version).
    ...
    def _ssim(im1, im2, window, window_size, channel):
    ...
    return _ssim(img, img2, window, window_size, channel)
