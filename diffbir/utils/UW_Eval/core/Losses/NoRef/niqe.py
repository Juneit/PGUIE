...
def cal_niqe(inputImgData):
    inputImgData = np.array(cv2.cvtColor(inputImgData, cv2.COLOR_RGB2GRAY))
...
if __name__ == "__main__":
    ...
    print('NIQE of ref bikes image is: %0.3f'% cal_niqe(ref))
    print('NIQE of dis bikes image is: %0.3f'% cal_niqe(dis))
    ...
    print('NIQE of ref parrot image is: %0.3f'% cal_niqe(ref))
    print('NIQE of dis parrot image is: %0.3f'% cal_niqe(dis))
